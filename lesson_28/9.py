...
# misol -> "Assistant Professor" -> "Junior Professor"assistant_count = 0
for employee in data:
    if "Assistant" in employee["position"]:
       employee["position"] = employee["position"].replace('Assistant', 'Junior')
