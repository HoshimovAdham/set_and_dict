...
print("\nHuman Resources Manager bo'limida ishlaydiganlar:")
# 1 - masala: Human Resources Manager bo'limida nechta odam ishlashini hisoblang
human_resources_count = 0
for employe in data:
    if employe["position"] == "Human Resources Manager":
        human_resources_count += 1

print(f"\nHuman Resources Manager bo'limida {human_resources_count} ta odam ishlaydi.")
