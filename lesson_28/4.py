...
print("\nHuman Resources Manager bo'limidagilar jami maoshi\n")
total_salary = 0
for employee in data:
    if employee["company"] == "Riffpath":
        salary = float(employee["salary"][1:])
        total_salary += salary

print(f"\nRiffpath kompaniyasida ishlaydiganlarning jami maoshi: ${total_salary:.2f}")
